        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(pageSelected == 0){
                    ...
                    Intent intent = new Intent(MainActivity.this, LorryDetailsActivity.class);
                    startActivity(intent);
                }
    ...
    ViewPager.OnPageChangeListener myOnPageChangeListener =
            new ViewPager.OnPageChangeListener(){
                ...
                public void onPageSelected(int position) {
                    ...
                    Log.e("test","page selected="+position);
                }};

    // Add Fragments to Tabs
    private void setupViewPager(ViewPager viewPager) {
        Adapter adapter = new Adapter(getSupportFragmentManager());
        adapter.addFragment(new ListCustomerFragment(), "Customer");
        adapter.addFragment(new ListLorryFragment(), "Lorry");
